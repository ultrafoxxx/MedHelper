...
function ajaxgetVisits(dates, placeName, specialty) {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/adminPanel/getVisitItems",
        cache: false,
        timeout: 600000,
...
function ajaxgetTimes(dates, placeId, doctorId, element) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "http://localhost:8080/adminPanel/getVisitTimes",
        cache: false,
        timeout: 600000,
        data: JSON.stringify(visits),
        headers: {
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                var myForm = $("<form action='http://localhost:8080/adminPanel/confirm' method='get'>");
